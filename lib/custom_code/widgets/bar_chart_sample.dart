...
class _BarChartSampleState extends State<BarChartSample> {
  ...
  Widget build(BuildContext context) {
    // Extrai a lista compraMensal do JSON completo
    List<dynamic> compraMensal = widget.jsonData['compraMensal'] ?? [];

    // Verifica se há dados em compraMensal
    List<BarChartGroupData> barGroups = compraMensal.isNotEmpty
        ? compraMensal.map((item) {
            int mes =
