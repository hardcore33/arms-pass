...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    procardTesteDeMelhoriasAuthUserSubject.add(
      ProcardTesteDeMelhoriasAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<ProcardTesteDeMelhoriasAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  ProcardTesteDeMelhoriasAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = ProcardTesteDeMelhoriasAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    procardTesteDeMelhoriasAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
ProcardTesteDeMelhoriasAuthUser? currentUser;
