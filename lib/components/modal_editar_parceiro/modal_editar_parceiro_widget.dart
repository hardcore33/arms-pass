...
class _ModalEditarParceiroWidgetState extends State<ModalEditarParceiroWidget> {
  ...
  void initState() {
    ...
    _model.cpfTextController ??= TextEditingController(
        text: getJsonField(
      widget!.dados,
      r'''$.partner.representative_cpf''',
    ).toString());
    _model.cpfFocusNode ??= FocusNode();

    _model.cpfMask = MaskTextInputFormatter(mask: '###.###.###-##');
    _model.phoneRepTextController ??= TextEditingController(
        text: getJsonField(
      widget!.dados,
      r'''$.partner.representative_number''',
    ).toString());
    ...
    _model.passRepTextController ??= TextEditingController(
        text: getJsonField(
      widget!.dados,
      r'''$.user.password''',
    ).toString());
          ...
          child: Column(
            ...
            children: [
              ...
              Align(
                alignment: AlignmentDirectional(-1.0, 0.0),
                child: Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(80.0, 10.0, 0.0, 0.0),
                  child: Container(
                    width: 300.0,
                    decoration: BoxDecoration(
                      border: Border.all(
              ...
              Row(
                ...
                children: [
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            ...
                            validator: _model.cnpjTextControllerValidator
                                .asValidator(context),
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(50.0, 0.0, 30.0, 0.0),
                    child: Row(
                      mainAxisSize: MainAxisSize.max,
                      children: [
                        Padding(
                          ...
                          child: FlutterFlowDropDown<String>(
                            controller: _model.segmentoValueController ??=
                              ...
                              _model.segmentoValue ??= getJsonField(
                                widget!.dados,
                                r'''$.partner.segment.name''',
                              ).toString(),
                            ),
                            options: _model.nomeDeSegmentos,
                            onChanged: (val) async {
                          ...
                          builder: (context) => Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                ...
                                _model.apiResult2sdalk =
                                    await ObterSegmentosCall.call();

                                if ((_model.apiResult2sdalk?.succeeded ??
                                    true)) {
                                  _model.segmentosAtualizados =
                                      await actions.obterListaDeSegmentos(
                                    (_model.apiResult2sdalk?.jsonBody ?? ''),
                                  );
                                  _model.nomeDeSegmentos = _model
                              ...
                              children: [
                                ...
                                FlutterFlowDropDown<String>(
                                  controller: _model.estadoValueController ??=
                                      FormFieldController<String>(
                                    _model.estadoValue ??= getJsonField(
                                      widget!.dados,
                                      r'''$.partner.state''',
                                    ).toString(),
                                  ),
                                  options: widget!.nomeDeEstados!,
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                ...
                                if (selectedMedia != null &&
                                  ...
                                  safeSetState(() => _model
                                      .isDataUploading_uploadData3m5 = true);
                                  ...
                                  try {
                                    ...
                                    ScaffoldMessenger.of(context)
                                        .hideCurrentSnackBar();
                                    _model.isDataUploading_uploadData3m5 =
                                        false;
                                  }
                                  if (selectedUploadedFiles.length ==
                                      selectedMedia.length) {
                                    safeSetState(() {
                                      _model.uploadedLocalFile_uploadData3m5 =
                                ...
                                if (_model.uploadedLocalFile_uploadData3m5 !=
                                        null &&
                                    (_model.uploadedLocalFile_uploadData3m5
                                            .bytes?.isNotEmpty ??
                                        false)) {
                                  ...
                                  _model.imagemUrll = _model.imageUrl;
                                  safeSetState(() {});
                                } else {
                                  await showDialog(
                                    context: context,
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            ...
                            cursorColor:
                                FlutterFlowTheme.of(context).primaryText,
                            validator: _model.nomeRepTextControllerValidator
                                .asValidator(context),
                          ),
                        ),
                      ],
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            ...
                            cursorColor:
                                FlutterFlowTheme.of(context).primaryText,
                            validator: _model.phoneRepTextControllerValidator
                                .asValidator(context),
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            ...
                            cursorColor:
                                FlutterFlowTheme.of(context).primaryText,
                            validator: _model.mailRepTextControllerValidator
                                .asValidator(context),
                          ),
                        ),
                      ],
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            ...
                            autofocus: false,
                            obscureText: !_model.passRepVisibility,
                            decoration: InputDecoration(
                              isDense: true,
                              labelStyle: FlutterFlowTheme.of(context)
                                  .labelMedium
                            ...
                            cursorColor:
                                FlutterFlowTheme.of(context).primaryText,
                            validator: _model.passRepTextControllerValidator
                                .asValidator(context),
                          ),
                        ),
                      ],
                        ...
                        onPressed: () async {
                          ...
                          if (selectedFiles != null) {
                            ...
                            try {
                              ...
                              _model.isDataUploading_uploadDataFt8 = false;
                            }
                            if (selectedUploadedFiles.length ==
                                selectedFiles.length) {
                              safeSetState(() {
                                _model.uploadedLocalFile_uploadDataFt8 =
                                    selectedUploadedFiles.first;
                              });
                            } else {
                              safeSetState(() {});
                          ...
                          if (_model.uploadedLocalFile_uploadDataFt8 != null &&
                              (_model.uploadedLocalFile_uploadDataFt8.bytes
                                      ?.isNotEmpty ??
                                  false)) {
                            _model.fileUrl = await actions.uploadFile(
                              _model.uploadedLocalFile_uploadDataFt8,
                            );
                            _model.hasNewContract = true;
                            safeSetState(() {});
                            await showDialog(
                              context: context,
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  title: Text('Contrato salvo'),
                                  content:
                                      Text('O contrato foi carregado e salvo.'),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
                    ...
                    child: Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          _model.apiResultjex =
                              await AtualizarParceiroCall.call(
                            idTenant:
                                functions.convertToInt(FFAppConstants.tenantId),
                            email: _model.emailTextController.text,
                            senha: _model.passRepTextController.text,
                            ...
                            telefoneRepresentante:
                                _model.phoneRepTextController.text,
                            representanteNome:
                                _model.nomeRepTextController.text,
                            selecionado: _model.switchValue,
                            contract: _model.isDataUploading_uploadDataFt8
                                ? _model.fileUrl
                                : getJsonField(
                                    widget!.dados,
                                    r'''$.partner.contract''',
                                  ).toString(),
                            photo: _model.hasNewPhoto
                                ? _model.imagemUrll
                                : getJsonField(
                                    widget!.dados,
                                    r'''$.partner.photo''',
                            ...
                            emailRepresentante:
                                _model.mailRepTextController.text,
                            ...
                            idPartner: getJsonField(
                              widget!.dados,
                              r'''$.partner.id''',
                            ).toString(),
                            idWallet: getJsonField(
                              widget!.dados,
                              r'''$.wallet.id''',
                            ).toString(),
                            idUser: getJsonField(
                          ...
                          if ((_model.apiResultjex?.succeeded ?? true)) {
                            await showDialog(
                              context: context,
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  title: Text('Parceiro editado com sucesso'),
                                  content: Text(
                                      'O parceiro foi editado com sucesso.'),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
                                          Navigator.pop(alertDialogContext),
