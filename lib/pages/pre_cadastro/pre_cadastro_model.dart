...
import '/index.dart';
import 'pre_cadastro_widget.dart' show PreCadastroWidget;
...
class PreCadastroModel extends FlutterFlowModel<PreCadastroWidget> {
  ...
  // Stores action output result for [Custom Action - getAddressByCep] action in TextField widget.
  dynamic? endereco;
  // State field(s) for TextField widget.
  ...
  // Stores action output result for [Backend Call - API (adicionarProposta)] action in Button widget.
  ApiCallResponse? apiResultr46;
  // State field(s) for TextField widget.
  ...
  late MaskTextInputFormatter textFieldMask14;
  ...
  late MaskTextInputFormatter textFieldMask16;
  String? Function(BuildContext, String?)? textController16Validator;
  // Stores action output result for [Custom Action - getAddressByCep] action in TextField widget.
  dynamic? enderecoMobile;
  // State field(s) for TextField widget.
